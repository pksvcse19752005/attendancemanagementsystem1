...
sender_pass = "pxbntsohbnbojhtw" # Use new Gmail app password without spaces
...
def save_attendance():
    ...
    # Insert or replace attendance records for each student regd
...
def send_reset_email(to_email):
    ...
    # Use SMTP_SSL on port 465 (updated from SMTP + STARTTLS)
...
if __name__ == "__main__":
    ...
    # For debugging only; remove debug=True for production
